...
/obj/item/clothing/suit/armor/ego_gear/realization/grinder
	...
	actions_types = list(/datum/action/item_action/grinder)
	var/jumpdistance = 7
	var/jumpspeed = 2
...
/obj/item/clothing/suit/armor/ego_gear/realization/confessional
	...
	actions_types = list(/datum/action/item_action/cross_spawn)
	var/recharging_rate = 200
	var/recharging_time = 0
	var/damage_amount = 200
	var/damage_range = 6
