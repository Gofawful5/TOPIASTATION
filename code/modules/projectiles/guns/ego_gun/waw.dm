...
/obj/item/gun/ego_gun/hornet/EgoAttackInfo(mob/user)
	if(chambered && chambered.loaded_projectile)
		return "<span class='notice'>Its bullets deal [chambered.loaded_projectile.damage] [chambered.loaded_projectile.damage_type] damage. Weapon does [force] [damtype] damage in melee.</span>"
	return
...
/obj/item/gun/ego_gun/hatred/EgoAttackInfo(mob/user)
	if(chambered && chambered.loaded_projectile)
		return "<span class='notice'>Its bullets deal [chambered.loaded_projectile.damage] randomly chosen damage.</span>"
	return
