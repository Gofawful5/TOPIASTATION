...
/obj/effect/magic_bullet/Moved(atom/old_loc, movement_dir, forced, list/old_locs, momentum_change = TRUE) // Shamelessly stolen code from immovable rod and paradise lost, GO!
